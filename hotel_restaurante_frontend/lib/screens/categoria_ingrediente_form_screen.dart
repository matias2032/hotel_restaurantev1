...
class CategoriaIngredienteFormScreen extends StatefulWidget {
  const CategoriaIngredienteFormScreen({super.key});

  @override
  State<CategoriaIngredienteFormScreen> createState() =>
      _CategoriaIngredienteFormScreenState();
}

class _CategoriaIngredienteFormScreenState
    extends State<CategoriaIngredienteFormScreen> {
  ...
  CategoriaIngredienteModel? _categoriaEdicao;
  ...
  void _carregarArgumentos() {
    ...
    if (args is CategoriaIngredienteModel) {
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      final categoria = CategoriaIngredienteModel(
        idCategoriaIngrediente: _categoriaEdicao?.idCategoriaIngrediente,
      ...
      if (_modoEdicao) {
        final id = _categoriaEdicao?.idCategoriaIngrediente;
  ...
  Widget build(BuildContext context) {
    final titulo =
        _modoEdicao ? 'Editar categoria' : 'Nova categoria de ingrediente';
                ...
                children: [
                  ...
                  Text(
                    _modoEdicao
                        ...
                        : 'Cadastre uma categoria para agrupar ingredientes semelhantes.',
                    style: const TextStyle(
                      color: _kMuted,
                      fontSize: 13,
                    ),
