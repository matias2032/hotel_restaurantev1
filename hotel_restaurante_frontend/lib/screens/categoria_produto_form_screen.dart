...
class CategoriaProdutoFormScreen extends StatefulWidget {
  const CategoriaProdutoFormScreen({super.key});

  @override
  State<CategoriaProdutoFormScreen> createState() =>
      _CategoriaProdutoFormScreenState();
}

class _CategoriaProdutoFormScreenState
    extends State<CategoriaProdutoFormScreen> {
  ...
  CategoriaProdutoModel? _categoriaEdicao;
  ...
  void _carregarArgumentos() {
    ...
    if (args is CategoriaProdutoModel) {
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      final categoria = CategoriaProdutoModel(
        idCategoriaProduto: _categoriaEdicao?.idCategoriaProduto,
      ...
      if (_modoEdicao) {
        final id = _categoriaEdicao?.idCategoriaProduto;
                ...
                children: [
                  ...
                  Text(
                    _modoEdicao
                        ...
                        : 'Cadastre uma categoria para agrupar produtos semelhantes.',
                    style: const TextStyle(
                      color: _kMuted,
                      fontSize: 13,
                    ),
